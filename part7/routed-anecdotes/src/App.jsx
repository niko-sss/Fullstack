...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <Link style={padding} to={"/info"}>about</Link>
    </div>
  )
}
...
const CreateNew = ({addNew, setNotification}) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log(anecdoteContent.value);
    addNew({
    ...
    setNotification(`a new anecdote ${anecdoteContent.value} by ${anecdoteAuthor.value} has been created.`)
    setTimeout(() => {
  ...
  const reset = () => {
    anecdoteContent.onReset()
    anecdoteAuthor.onReset()
    anecdoteInfo.onReset()
  }
